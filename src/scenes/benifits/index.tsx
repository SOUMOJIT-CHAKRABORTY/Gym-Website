...
function Benifits({ setPageSelected }: Props) {
  const benifitObject: Array<BenifitsType> = [
    {
      icon: <HomeModernIcon className="h-6 w-6" />,
      title: "State of the Art Ficilities",
      description:
  ...
  return (
    <section id="benifits" className="mx-auto min-h-full w-5/6 py-20">
      <motion.div
        onViewportEnter={() => setPageSelected(SelectedPage.Benifits)}
      >
        {/* HEADER */}
        <motion.div
        ...
        >
          {benifitObject.map((benifit: BenifitsType) => (
            <Benifit
              key={benifit.title}
              icon={benifit.icon}
              title={benifit.title}
